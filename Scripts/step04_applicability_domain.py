...
Usage:
    python Scripts/step04_applicability_domain.py \
        ...
        --train-data models_out/classification_20260329_165120/split_seed_29/data/train_features.npz \
        --external-data models_out/classification_20260329_165120/split_seed_29/data/splits/external_test.npz \
        --predictions models_out/classification_20260329_165120/split_seed_29/predictions/external_test_predictions.csv \
        -m RFC -s 42
