        ...
        if fp_type == "morgan":
            ...
            for smiles in tqdm(smiles_list, desc=f"Generating {fp_type} fingerprints"):
                try:
                    ...
                    fingerprints.append(np.zeros(2048))
            fp_df = pd.DataFrame(fingerprints, columns=[f'morgan_{i}' for i in range(2048)])
